...
Mathieu
- Bioinformatics: Hierarchical deep learning for GWAS by integrating protein structure – DeepProtGO. Makes GO annotations. Integrates protein databases. Allows to GO annotation protein structures. Extrapolating from known structures.
- Nature: Go rhythm – hyrax that breed keep the beat. Original paper referred to by: reproduction success and hyraxes (Animal Ecology).
- Opinion paper in Conservation Genetics: Evolution of proposed genetic goals... genetic diversity. Frankham (?). Rio convention 1990. How much genetic diversity should be maintained (how much loss acceptable) for a species? Convention came up with a margin. Frankham now investigates how much biodiversity is lost according to this framework. Proposes alternative measures to quantify genetic diversity: population size, population connectivity, removing barriers, habitat corridors, moving populations or individuals. Effective population size is too complex a parameter to work with to be effective measurement. Reinforcing that $N_e$ is about 1/10 of $N_c$.

Thomas
- PLoS Comput Biol: Negative social interaction, honeybee defence (unclear why Thomas picked this paper)
- G3: Murga-Morreno... Barbadilla: Imputed MK test – straightforward correction increasing power to detect positive selection. Extension of the Fu et al. MK test (FW MK test). Positive selection is underestimated due to weak background selection. Approach: Imputing the proportion of slightly deleterious mutations from the SNF. Increase in proportion of positive selection discovered. Needs fewer genes to reach statistical power.

Noel
- J Evol Biol: Opedal et al. Floral scent and selection. Quantify selection on scent and interaction with pollinators.
- J Evol Biol: Westrahm et al and Nick. Reproductive isolation depends on circumstances. Could be a controversial article.
- Evolution: Xion and Mallet. Collapse of self-incompatibility with increasing hybridisation. Then formation of a new species via fusion (hybridisation).

Anna
- Trends Evol Evol: Infectious disease and recognition. Learn, pay attention, remember. Disease could affect learning and adapting. 1) Direct effects of parasites. 2) Indirect effect of host response. 3) Missed learning (not paying attention).

Glauco
- Genome Res: Domestic sheep and wild cousins and hybrids. Genomics.

Gözde
- Mol Biol Evol: : Museum and contemporary samples. WGS for a songbird clade. Comprehensive phylogenomics analysis. Substantial biodiversity loss. Highlights museum samples and how ancient samples can be used in conservation.
- Ecol and Evol: : Ecologist career compressed. Aims to familiarise people with different career paths that can be taken.

José
- Science Adv: : Coral reefs. Adaptive and plastic genes coopting to increase resilience to change in temperature.